...
def insert_image(excel_path, image_path, cell):
    vba_code = """
Sub InsertImage(image As String, cell as String)
    Range(cell).Select
    Selection.InsertPictureInCell(image)
End Sub
"""
    ...
    try:
        ...
        excel.Application.Run("InsertImage", os.path.abspath(image_path), cell)
...
insert_image("assets\\test.xlsx", "assets\\star.jpg", "A10")